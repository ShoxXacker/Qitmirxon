<?php
ob_start();
define('API_KEY', '1279311614:AAFmvcNkb7DYC4WMwYnTKA2C1qZOSL5vBQE');
//tokenni yozing

/*Bot kodi 100% bexato ishlaydi. kod @HP_CoDs kanali orqali tarqatildi.*/
...
if($text1 == "/start" or $text1 == "/start@QITMIRXON_UZBOT"){
  ...
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'Buyruqlar', 'callback_data' => "stat"],['text'=>'Statistika', 'callback_data' => "stat1"]],
          [['text'=>'Guruhga Qo‘shish','url'=>'telegram.me/QITMIRXON_UZBOT?startgroup=new']]
]   
]),
]);
}
...
- Bot guruh yangi a‘zolari bilan salomlashadi.Guruh a‘zosi guruhga reklama <b>ssilkalarini</b> tashlasa yoki <b>haqoratli</b> so‘z yozsa,bot xabarni o‘chirib foydalanuvchiga cheklov beradi.\n\n<b>Yaratuvchi🛠:</b>  <a href='tg://user?id=1171894731'>Shox Xacker</a>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['url' => 'https://telegram.me/QITMIRXON_UZBOT?startgroup=new', 'text' => "Guruhga Qo‘shish"],],
]
]),
]);
}

if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@QITMIRXON_BOT"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
if((mb_stripos($mtext,"Ziyomat") !== false)){ 
bot('SendMessage',[
'chat_id'=>$chat_id,
...
if((mb_stripos($mtext,"ziyonur") !== false) or (mb_stripos($mtext,"zed")!==false) or (stripos($mtext,"blogger")!==false) or (mb_stripos($mtext,"admin")!==false) or (mb_stripos($mtext,"зед")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if($text1 =="Banan" or $text1 == "XXayr"&&$fadmin==$admin){
